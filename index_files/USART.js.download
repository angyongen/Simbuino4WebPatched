$(function () {
	...
	USART = {
		...
		UDR0_OnRegisterChanged: function(oldVal, newVal)
		{
			...
			var textarea = document.getElementById('serial')
			if (newVal!=10)textarea.value+=(String.fromCharCode(newVal))
			if (newVal==13)textarea.scrollTop = textarea.scrollHeight;
